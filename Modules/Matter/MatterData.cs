function SetupMatterData()
{
	...
	new SimSet(MatterData)
	{
		...
		new ScriptObject(MatterType) { codename="ore4_0"; name="Bismuth";				data=brickMMBrickGenericData;	color="899549ff";	colorFX=0;	shapeFX=0;	printID="ModTer/brickRAMP";	value=22222;health=200000;	level=480;	hitSound="Metal";};
		new ScriptObject(MatterType) { codename="ore4_1"; name="Helium";				data=brickMMBrickGenericData;	color="b8b3aaff";	colorFX=5;	shapeFX=0;	printID="Letters/-space";	value=24444;health=220000;		level=480;	hitSound="Metal"; };
		new ScriptObject(MatterType) { codename="ore4_2"; name="Krypton";				data=brickMMBrickGenericData;	color="1f568cff";	colorFX=5;	shapeFX=0;	printID="Letters/-space";	value=25555;health=230000;		level=480;	hitSound="Metal"; };
		new ScriptObject(MatterType) { codename="ore4_3"; name="Xenon";				data=brickMMBrickGenericData;	color="49285bff";	colorFX=5;	shapeFX=0;	printID="Letters/-space";	value=26666;health=240000;		level=500;	hitSound="Metal"; };
		...
		new ScriptObject(MatterType) { codename="ore4_9"; name="Americium";			data=brickMMBrickGenericData;	color="e8e4e2ff";	colorFX=0;	shapeFX=0;	printID="ModTer/america";	value=111308;health=1001776;	level=725;	hitSound="Metal";	hitFunc="MM_RadDamage";	hitFuncArgs=15;	harvestFunc="MM_HeatDamage";	harvestFuncArgs=30; };
		...
		new ScriptObject(MatterType) { codename="forb"; name="Frenzy Orb";				data=brickMMBrickOrbData;	color="89a3b8ff";	colorFX=3;	shapeFX=1;	value=50;	health=1000000;	level=10;	hitSound="Wood";	unobtainable=true; bombResist=1.0;	harvestFunc="MM_ServerBuff";	harvestFuncArgs="Frenzy";	hitFunc="MM_RadDamage";			hitFuncArgs=2; noDupe=true; };
		new ScriptObject(MatterType) { codename="lorb"; name="Lotto Orb";				data=brickMMBrickOrbData;	color="89bc77ff";	colorFX=3;	shapeFX=1;	value=100;	health=1000000;	level=10;	hitSound="Wood";	unobtainable=true; bombResist=1.0;	harvestFunc="MM_ServerBuff";	harvestFuncArgs="Lotto";	hitFunc="MM_RadDamage";			hitFuncArgs=2; noDupe=true;  };
		new ScriptObject(MatterType) { codename="borb"; name="Berserk Orb";				data=brickMMBrickOrbData;	color="db9085ff";	colorFX=3;	shapeFX=1;	value=200;	health=1000000;	level=10;	hitSound="Wood";	unobtainable=true; bombResist=1.0;	harvestFunc="MM_ServerBuff";	harvestFuncArgs="Berserk";	hitFunc="MM_RadDamage";			hitFuncArgs=2; noDupe=true;  };
		new ScriptObject(MatterType) { codename="morb"; name="Mythical Orb";				data=brickMMBrickOrbData;	color="dfc37cff";	colorFX=2;	shapeFX=1;	value=400;	health=3000000;	level=10;	hitSound="Wood";	unobtainable=true; bombResist=1.0;	harvestFunc="MM_ServerBuff";	harvestFuncArgs="Mystical";	hitFunc="MM_RadDamage";			hitFuncArgs=8; noDupe=true;  };
		new ScriptObject(MatterType) { codename="eorb"; name="Extender Orb";				data=brickMMBrickOrbData;	color="e8e4e2ff";	colorFX=6;	shapeFX=1;	value=800;	health=750000;	level=10;	hitSound="Wood";	unobtainable=true; bombResist=1.0;	harvestFunc="MM_ServerBuff";	harvestFuncArgs="Extender";	hitFunc="MM_RadDamage";			hitFuncArgs=4; noDupe=true;  };
